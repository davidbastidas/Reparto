...
public class Auditorias {
    ...
    public long getLectorAsignadoId() {
        return lectorAsignadoId;
    }

    public void setLectorAsignadoId(long lectorAsignadoId) {
        this.lectorAsignadoId = lectorAsignadoId;
    }
